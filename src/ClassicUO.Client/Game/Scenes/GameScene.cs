...
namespace ClassicUO.Game.Scenes
{
    internal partial class GameScene : Scene
    {
        ...
        public override void Load()
        {
            ...
            if (prof != null && prof.UOClassicCombatBuffbar && prof.UOClassicCombatBuffbar_SwingEnabled)
            {
                UIManager.Add(
                    new UOClassicCombatSwingGump(_world)
                    {
                        X = prof.UOClassicCombatBuffbarLocation.X,
            ...
            if (prof != null && prof.AllyRangeIndicator)
            {
                AllyRangeIndicatorGump.RefreshOpenGump(_world);
            }
